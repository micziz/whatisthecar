...
<main>
    ...
    {:else}
        ...
        <div id="buttons">
            <button class="button is-link is-rounded is-outlined" id="btn1" on:click={() => checkCar(1)}>Esta</button>
            <button class="button is-link is-rounded is-outlined" id="btn2" on:click={() => checkCar(2)}>Esta</button>
        </div>
  {/if}
</main>
